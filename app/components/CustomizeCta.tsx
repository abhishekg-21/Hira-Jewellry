...
export default function CustomizeCta() {
  return (
    <section className="w-full bg-[#fdf9f4]">
      <div className="max-w-5xl mx-auto px-4 py-12 sm:py-16 md:py-24 text-center">
        {/* Small eyebrow label */}
        <p className="text-[11px] sm:text-[12px] tracking-[0.25em] text-black/80 mb-3 sm:mb-4">
          CUSTOM
        </p>

        {/* Big headline */}
        <h2 className="text-[26px] sm:text-[34px] md:text-[56px] leading-snug font-semibold text-black mb-4 sm:mb-6">
          Customize Jewellery
        </h2>

        {/* Description */}
        <p className="max-w-2xl mx-auto text-[14px] sm:text-[16px] md:text-[18px] text-black/80 leading-relaxed mb-8 sm:mb-10">
